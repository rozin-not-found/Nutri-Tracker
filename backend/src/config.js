...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'b785be21e8148eb238f21fc0ac5afd51',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Nutri-Tracker <app@flatlogic.app>',
  ...
  project_uuid: '3649be91-5dbd-4077-ab1f-be0afa04f390',
  flHost:
...
config.pexelsQuery = 'healthy fresh food concept';
config.host =
