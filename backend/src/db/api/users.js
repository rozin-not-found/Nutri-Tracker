...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setShop(data.data.shop || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setShop(data.shop || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.orders_receptionist = await users.getOrders_receptionist({
      transaction,
    });
    ...
    output.shop = await users.getShop({
      transaction,
    });
