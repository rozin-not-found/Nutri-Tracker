module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('shops', 'shopId', { transaction });

      await queryInterface.removeColumn('order_items', 'shopId', {
        transaction,
      });

      await queryInterface.removeColumn('users', 'shopId', { transaction });

      await queryInterface.removeColumn('roles', 'globalAccess', {
        transaction,
      });

      await queryInterface.removeColumn('shop', 'name', { transaction });
      ...
      await queryInterface.removeColumn('orders', 'shopId', { transaction });
      ...
      await queryInterface.removeColumn('menu_items', 'name', { transaction });
      ...
      await queryInterface.dropTable('shop', { transaction });
