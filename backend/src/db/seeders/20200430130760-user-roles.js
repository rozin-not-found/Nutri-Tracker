...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('order_coordinator'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('customer_service'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('SuperAdmin'),
        permissionId: getId('CREATE_SHOP'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('SuperAdmin'),
        permissionId: getId('READ_SHOP'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('SuperAdmin'),
        permissionId: getId('UPDATE_SHOP'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('SuperAdmin'),
        permissionId: getId('DELETE_SHOP'),
      },
