    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.orders_customer &&
                      Array.isArray(users.orders_customer) &&
                      users.orders_customer.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
          ...
          <>
            <p className={'block font-bold mb-2'}>Orders Receptionist</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.orders_receptionist &&
                      Array.isArray(users.orders_receptionist) &&
                      users.orders_receptionist.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/orders/orders-view/?id=${item.id}`)
              ...
              {!users?.orders_receptionist?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
